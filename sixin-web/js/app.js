window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://ip:5929/siyiyimiaozhong',
	
	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: 'http://ip:5928',
	
 	/**
	 * 图片服务器的url地址
	 */
	imgServerUrl: 'http://ip/',
	...
	readUserChatSnapshot: function(myId,friendId){
		...
		if(me.isNotNull(chatSnapshotListStr)){
			...
			//如果有，在list中的原有位置删除 快照 对象，然后重新放入一个标记已读的快照对象
			for(var i=0;i<chatSnapshotList.length;i++){
				//删除已经存在的friendId所对应的快照对象
